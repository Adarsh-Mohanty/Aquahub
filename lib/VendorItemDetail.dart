import 'package:aquahub/iteminvoice.dart';
import 'package:aquahub/transitions.dart';
import 'package:carousel_slider/carousel_slider.dart';
import 'package:fl_chart/fl_chart.dart';
import 'package:flutter/material.dart';

class VendorItemDetail extends StatefulWidget {
  final String name;
  final String image;
  final int index;
  VendorItemDetail(this.name, this.image, this.index);
  @override
  _VendorItemDetailState createState() => _VendorItemDetailState();
}

class _VendorItemDetailState extends State<VendorItemDetail> {
  int currentPage;
  List title;
  @override
  void initState() {
                        ...
                        child: InkWell(
                          onTap: () {
                            Navigator.push(
                              ...
                              EnterExitRoute(
                                exitPage: widget,
                                enterPage: ItemInvoices(
                                    widget.name, widget.image, widget.index),
                              ),
                            );
                          },
                          child: Column(
