import 'package:aquahub/PurchaseDetail.dart';
                  ...
                  RichText(
                    ...
                    text: TextSpan(
                      children: <TextSpan>[
                        ...
                        TextSpan(
                          text: "\nBought at ${Purchase[index].boughtat}",
                          style: TextStyle(
                        ...
                        TextSpan(
                          text: "\nLatest Purchase: ${Purchase[index].latest}",
                          style: TextStyle(
                        ...
                        TextSpan(
                          text:
                              "\nTotal Purchases: ${Purchase[index].totalpurchase}",
                          style: TextStyle(
                            color: Color.fromRGBO(3, 3, 3, 1),
                            fontSize: 16,
                            fontFamily: 'raleway',
